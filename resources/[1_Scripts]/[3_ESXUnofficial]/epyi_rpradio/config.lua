...
Config.menuStyle = {
	...
	bannerStyle = {
		...
		imageUrl = 'https://cdn.discordapp.com/attachments/1318687173289050144/1357814887090229390/image.png?ex=67f19328&is=67f041a8&hm=d2bc69bce45c2f48fd58d9992a6d2f28f4971d529287c60a7bd0a981457103d7&', -- [nil/string] → Set a custom image url if you want (if set, it will disable the color configuration)
		imageSize = { width = 150, height = 170 }, -- [table] → Set the image (imageUrl) size un pixels
