...
function main_vehicles_current_showContentThisFrame(playerGroup)
	...
	RageUI.ButtonWithStyle(_U("main_vehicles_current_repair"), _U("main_vehicles_current_repair_desc"), {}, Config.Groups[playerGroup].Access["submenu_vehicles_current_repair"], function(_h, _a, Selected)
		if Selected then
	...
	RageUI.ButtonWithStyle(_U("main_vehicles_current_clean"), _U("main_vehicles_current_clean_desc"), {}, Config.Groups[playerGroup].Access["submenu_vehicles_current_clean"], function(_h, _a, Selected)
		if Selected then
			if not pedVehicle or GetPedInVehicleSeat(pedVehicle, -1) ~= ped then
				ESX.ShowNotification(_U("self_not_in_vehicle"))
				return
	...
	RageUI.ButtonWithStyle(_U("main_vehicles_current_flip"), _U("main_vehicles_current_flip_desc"), {}, Config.Groups[playerGroup].Access["submenu_vehicles_current_flip"], function(_h, _a, Selected)
		if Selected then
			if not pedVehicle or GetPedInVehicleSeat(pedVehicle, -1) ~= ped then
				ESX.ShowNotification(_U("self_not_in_vehicle"))
				return
	...
	RageUI.ButtonWithStyle(_U("main_vehicles_current_fuel"), _U("main_vehicles_current_fuel_desc"), {}, Config.Groups[playerGroup].Access["submenu_vehicles_current_fuel"], function(_h, _a, Selected)
		if Selected then
			if not pedVehicle or GetPedInVehicleSeat(pedVehicle, -1) ~= ped then
				ESX.ShowNotification(_U("self_not_in_vehicle"))
				return
	...
	RageUI.Checkbox(_U("main_vehicles_current_engine"), _U("main_vehicles_current_engine_desc"), GetIsVehicleEngineRunning(pedVehicle), {
	...
	RageUI.Checkbox(_U("main_vehicles_current_freeze"), _U("main_vehicles_current_freeze_desc"), IsEntityPositionFrozen(pedVehicle), {
	...
	RageUI.List(_U("main_vehicles_current_open_door"), _var.vehicle.doorArray, _var.vehicle.doorArrayIndex, _U("main_vehicles_current_open_door_desc"), {}, Config.Groups[playerGroup].Access["submenu_vehicles_current_opendoor"], function(_h, _a, Selected, Index)
	...
	RageUI.List(_U("main_vehicles_current_boost"), _var.vehicle.boostArray, _var.vehicle.boostArrayIndex, _U("main_vehicles_current_boost_desc"), {}, Config.Groups[playerGroup].Access["submenu_vehicles_current_boost"], function(_h, _a, Selected, Index)
