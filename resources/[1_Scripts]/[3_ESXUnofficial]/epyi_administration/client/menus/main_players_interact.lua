...
function main_players_interact_showContentThisFrame(playerGroup)
	...
	RageUI.ButtonWithStyle(_U("main_players_interact_bring"), _U("main_players_interact_bring_desc"), {}, Config.Groups[playerGroup].Access["submenu_players_interact_bring"] and not _var.menus.admin.cooldowns.items, function(_h, _a, Selected)
		if Selected then
			Citizen.CreateThread(function()
				_var.menus.admin.cooldowns.items = true
				ESX.TriggerServerCallback("epyi_administration:setCoords", function(result)
	...
	-- 	end
	-- )
	RageUI.ButtonWithStyle(_U("main_players_interact_dm"), _U("main_players_interact_dm_desc"), {}, Config.Groups[playerGroup].Access["submenu_players_interact_dm"] and not _var.menus.admin.cooldowns.items, function(_h, _a, Selected)
		if Selected then
			Citizen.CreateThread(function()
				_var.menus.admin.cooldowns.items = true
	...
	RageUI.ButtonWithStyle(_U("main_players_interact_kick"), _U("main_players_interact_kick_desc"), {}, Config.Groups[playerGroup].Access["submenu_players_interact_kick"] and not _var.menus.admin.cooldowns.items, function(_h, _a, Selected)
		if Selected then
			Citizen.CreateThread(function()
				_var.menus.admin.cooldowns.items = true
	...
	RageUI.ButtonWithStyle(_U("main_players_interact_ban"), _U("main_players_interact_ban_desc"), {}, Config.Groups[playerGroup].Access["submenu_players_interact_ban"] and not _var.menus.admin.cooldowns.items, function(_h, _a, Selected)
		if Selected then
			Citizen.CreateThread(function()
				_var.menus.admin.cooldowns.items = true
				local reason = textEntry(_U("textentry_reason"), "", 50)
