...
function main_personnal_showContentThisFrame(playerGroup)
	...
	RageUI.List(_U("main_personnal_health_management"), playerOptionsArray, playerOptionsArrayIndex, _U("main_personnal_health_management_desc"), {}, Config.Groups[playerGroup].Access["submenu_personnal_health_management"], function(_h, _a, Selected, Index)
	...
	RageUI.ButtonWithStyle(_U("main_personnal_appearance"), _U("main_personnal_appearance_desc"), { RightLabel = "→" }, Config.Groups[playerGroup].Access["submenu_personnal_appearance"], function(_h, _a, _s) end, _var.menus.admin.objects.mainPersonnalAppearance)
	RageUI.Checkbox(_U("main_personnal_noclip"), _U("main_personnal_noclip_desc"), _threads.noclip.isActivated, {
	...
	RageUI.Checkbox(_U("main_personnal_godmode"), _U("main_personnal_godmode_desc"), _threads.godmode.isActivated, {
	...
	RageUI.Checkbox(_U("main_personnal_invisibility"), _U("main_personnal_invisibility_desc"), _threads.invisibility.isActivated, {
	...
	RageUI.Checkbox(_U("main_personnal_fastwalk"), _U("main_personnal_fastwalk_desc"), _threads.fastwalk.isActivated, {
	...
	RageUI.Checkbox(_U("main_personnal_fastswim"), _U("main_personnal_fastswim_desc"), _threads.fastswim.isActivated, {
	...
	RageUI.Checkbox(_U("main_personnal_superjump"), _U("main_personnal_superjump_desc"), _threads.superjump.isActivated, {
	...
	RageUI.Checkbox(_U("main_personnal_stayinvehicle"), _U("main_personnal_stayinvehicle_desc"), _threads.stayinvehicle.isActivated, {
	...
	RageUI.Checkbox(_U("main_personnal_seethrough"), _U("main_personnal_seethrough_desc"), _threads.seethrough.isActivated, {
	...
	RageUI.Checkbox(_U("main_personnal_shownames"), _U("main_personnal_shownames_desc"), _threads.shownames.isActivated, {
