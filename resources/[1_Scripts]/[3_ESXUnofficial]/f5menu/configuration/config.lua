...
Config.Navigation = {
    ...
    destinations = { --| Place here your locations
        { name = 'LSPD', coords = vector3(407.6613, -986.1854, 29.2603-0.9), icon = 'fa-solid fa-building-shield', image = '' },
        { name = 'EMS', coords = vector3(291.7147, -586.7615, 43.1760-0.9), icon = 'fa-solid fa-house-medical', image = '' },
        { name = 'Mécano', coords = vector3(-377.3869, -131.3874, 38.6804-0.9), icon = 'fa-solid fa-toolbox', image = '' },
...
Config.Information = {
    { label = 'Discord', value = 'https://discord.gg/fTyQAaTS' },
